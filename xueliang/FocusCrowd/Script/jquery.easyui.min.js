...
(function ($) {
    ...
    $.fn.layout.parseOptions = function (_419) {
        return $.extend({}, $.parser.parseOptions(_419, [{
            fit: "boolean"
        }]));
    };
    $.fn.layout.defaults = {
...
(function ($) {
    ...
    function _429(_42c, div, _42d) {
        var item = $(div);
        var _42e = $.extend({}, $.parser.parseOptions(item[0], ["id", "name", "iconCls", "href", {
            separator: "boolean"
        }]), {
    ...
    $.fn.menu = function (_469, _46a) {
        ...
        return this.each(function () {
            ...
            if (_46b) {
                ...
                _46b = $.data(this, "menu", {
                    options: $.extend({}, $.fn.menu.defaults, $.fn.menu.parseOptions(this), _469)
                });
                init(this);
            }
            $(this).css({
                left: _46b.options.left,
                top: _46b.options.top
            });
        });
    };
    $.fn.menu.methods = {
        ...
        return this.each(function () {
            ...
            if (_488) {
                ...
                $.data(this, "menubutton", {
                    options: $.extend({}, $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _485)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_48f) {
                ...
                $.data(this, "splitbutton", {
                    options: $.extend({}, $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _48c)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.splitbutton.methods = {
        options: function (jq) {
            ...
            $.extend(_491, {
                disabled: _490.disabled,
                toggle: _490.toggle,
                selected: _490.selected
            });
            return _491;
        }
    };
...
(function ($) {
    ...
    function _496(_497, _498) {
        ...
        var _49d = w * 2 - _49c;
        _49a.find(".switchbutton-inner").css({
            width: _49d + "px",
            height: h + "px",
            lineHeight: h + "px"
        });
        _49a.find(".switchbutton-handle")._outerWidth(_49c)._outerHeight(h).css({
            marginLeft: -_49c / 2 + "px"
        });
    ...
    $.fn.switchbutton.methods = {
        options: function (jq) {
            ...
            return $.extend(_4bc.options, {
                value: _4bc.switchbutton.find(".switchbutton-value").val()
            });
        },
    ...
    $.fn.validatebox = function (_4ee, _4ef) {
        ...
        return this.each(function () {
            ...
            if (_4f0) {
                ...
                init(this);
                _4f0 = $.data(this, "validatebox", {
                    options: $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _4ee)
                });
            }
...
(function ($) {
    ...
    function _50a(_50b, _50c) {
        ...
        if (opts.multiline) {
            _510.css({
                paddingTop: (_50b.style.paddingTop || ""),
                paddingBottom: (_50b.style.paddingBottom || "")
            });
        ...
        if (!opts.disabled && !opts.readonly) {
            if (_520.label) {
                $(_520.label).bind("click.textbox", function (e) {
                    if (!opts.hasFocusMe) {
                        _521.focus();
                        $(_51f).textbox("setSelectionRange", {
                            start: 0,
                            end: _521.val().length
                        });
                    }
            ...
            for (var _522 in opts.inputEvents) {
                _521.bind(_522 + ".textbox", {
                    target: _51f
                }, opts.inputEvents[_522]);
            }
        }
        var _523 = tb.find(".textbox-addon");
        _523.unbind().bind("click", {
            target: _51f
        }, function (e) {
        ...
        cloneFrom: function (jq, from) {
            return jq.each(function () {
                ...
                $.data(this, "textbox", {
                    options: opts,
                    textbox: span,
                    label: (_535.length ? _535 : undefined)
                });
...
(function ($) {
    function _555(_556) {
        ...
        $(_556).addClass("passwordbox-f").textbox($.extend({}, opts, {
            icons: _558
        }));
        _559(_556);
    };
    ...
    $.fn.passwordbox = function (_568, _569) {
        ...
        return this.each(function () {
            ...
            if (_56b) {
                ...
                _56b = $.data(this, "passwordbox", {
                    options: $.extend({}, $.fn.passwordbox.defaults, $.fn.passwordbox.parseOptions(this), _568)
                });
            }
            _555(this);
        });
...
(function ($) {
    ...
    function _578(_579, c) {
        ...
        if (_57b != -1) {
            ...
            if (r.test(c)) {
                ...
                _57b = _57c(_579, ++_57b);
                $(_579).maskedbox("setSelectionRange", {
                    start: _57b,
                    end: _57b
                });
            }
    ...
    function _580(_581, _582) {
        ...
        $(_581).maskedbox("setSelectionRange", {
            start: _584,
            end: _584
        });
    };
        ...
        inputMask: function (jq, _58f) {
            return jq.each(function () {
                ...
                for (var _592 in opts.inputEvents) {
                    _591.bind(_592 + ".maskedbox", {
                        target: _590
                    }, opts.inputEvents[_592]);
                }
            });
        }
    });
    $.fn.maskedbox = function (_593, _594) {
        ...
        return this.each(function () {
            ...
            if (_596) {
                ...
                $.data(this, "maskedbox", {
                    options: $.extend({}, $.fn.maskedbox.defaults, $.fn.maskedbox.parseOptions(this), _593)
                });
            }
            _56f(this);
        });
...
(function ($) {
    ...
    $.fn.filebox = function (_5a2, _5a3) {
        ...
        return this.each(function () {
            ...
            if (_5a5) {
                ...
                $.data(this, "filebox", {
                    options: $.extend({}, $.fn.filebox.defaults, $.fn.filebox.parseOptions(this), _5a2)
                });
            }
            _59b(this);
        });
    ...
    $.fn.filebox.parseOptions = function (_5a6) {
        var t = $(_5a6);
        return $.extend({}, $.fn.textbox.parseOptions(_5a6), $.parser.parseOptions(_5a6, ["accept", "capture", "separator"]), {
...
(function ($) {
    function _5a7(_5a8) {
        ...
        _5ab();
        var _5ac = _5ad();
        $(_5a8).addClass("searchbox-f").textbox($.extend({}, opts, {
            icons: _5aa,
            buttonText: (_5ac ? _5ac.text : "")
        }));
        ...
        function _5ad() {
            if (_5a9.menu) {
                ...
                _5a9.menu.children("div.menu-item").each(function () {
                    var _5b1 = $.extend({}, $.parser.parseOptions(this), {
                        selected: ($(this).attr("selected") ? true : undefined)
                    });
                    if (_5b1.selected) {
                        item = $(this);
    ...
    $.fn.searchbox = function (_5b2, _5b3) {
        ...
        return this.each(function () {
            ...
            if (_5b5) {
                ...
                $.data(this, "searchbox", {
                    options: $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _5b2)
                });
            }
            _5a7(this);
        });
    ...
    $.fn.searchbox.parseOptions = function (_5b6) {
        var t = $(_5b6);
        return $.extend({}, $.fn.textbox.parseOptions(_5b6), $.parser.parseOptions(_5b6, ["menu"]), {
...
(function ($) {
    ...
    function _5e3(_5e4, _5e5) {
        ...
        if (_5e6) {
            ...
            $.data(_5e4, "form", {
                options: $.extend({}, $.fn.form.defaults, $.fn.form.parseOptions(_5e4), _5e5)
            });
        }
    };
    ...
    $.fn.numberbox = function (_5fd, _5fe) {
        ...
        return this.each(function () {
            ...
            if (_600) {
                ...
                _600 = $.data(this, "numberbox", {
                    options: $.extend({}, $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _5fd)
                });
            }
            _5f4(this);
        });
    ...
    $.fn.calendar = function (_630, _631) {
        ...
        return this.each(function () {
            ...
            if (_632) {
                ...
                _632 = $.data(this, "calendar", {
                    options: $.extend({}, $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _630)
                });
                init(this);
            }
    ...
    $.fn.spinner = function (_64a, _64b) {
        ...
        return this.each(function () {
            ...
            if (_64d) {
                ...
                _64d = $.data(this, "spinner", {
                    options: $.extend({}, $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _64a)
                });
            }
            _63a(this);
        });
        ...
        return this.each(function () {
            ...
            if (_656) {
                ...
                $.data(this, "numberspinner", {
                    options: $.extend({}, $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _653)
                });
            }
            _64f(this);
        });
...
(function ($) {
    ...
    function _65f(_660, _661) {
        ...
        if (_662) {
            ...
            $(_660).timespinner("setSelectionRange", {
                start: _662[0],
                end: _662[1]
            });
            tb.focus();
        ...
        return this.each(function () {
            ...
            if (_66c) {
                ...
                $.data(this, "timespinner", {
                    options: $.extend({}, $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _669)
                });
            }
            _658(this);
        });
...
(function ($) {
        ...
        _6e0.each(function () {
            $(this).resizable({
                ...
                onStartResize: function (e) {
                    ...
                    _6dc.proxy.css({
                        left: e.pageX - $(_6dd).offset().left - 1 + e.data.deltaEdge,
                        display: "none"
                    });
                    setTimeout(function () {
                        if (_6dc.proxy) {
            ...
            if (col && col.editor) {
                ...
                if (_7c3) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _7c3,
                        target: _7c3.init(cell.find("td"), $.extend({
    ...
    function _7d1(_7d2, _7d3) {
        ...
        $(_7d2).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
    ...
    function _7d7(_7d8, _7d9) {
        ...
        _7da.push(_7d9.row);
        $(_7d8).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
    ...
    function _7db(_7dc, row) {
        ...
        _7dd.push(row);
        $(_7dc).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
        ...
        return this.each(function () {
            ...
            if (_803) {
                ...
                opts = $.extend({}, $.extend({}, $.fn.datagrid.defaults, {
                    queryParams: {}
                }), $.fn.datagrid.parseOptions(this), _801);
    ...
    $.fn.datagrid.methods = {
        ...
        gotoPage: function (jq, _857) {
            return jq.each(function () {
                ...
                $(_858).datagrid("getPager").pagination("refresh", {
                    pageNumber: page
                });
...
(function ($) {
    ...
    $.fn.propertygrid.parseOptions = function (_8ec) {
        return $.extend({}, $.fn.datagrid.parseOptions(_8ec), $.parser.parseOptions(_8ec, [{
            showGroup: "boolean"
        }]));
    };
        ...
        insertRow: function (_918, _919, row) {
            ...
            if (_91b) {
                ...
                _91b = {
                    value: row[opts.groupField],
                    rows: [row],
                    startIndex: _91a.data.rows.length
                };
...
(function ($) {
    ...
    function _9ad(_9ae, _9af) {
        ...
        _9a8(_9ae, {
            parent: (_9b0 ? _9b0[opts.idField] : null),
            data: [_9af.data]
        });
    ...
    function _9b7(_9b8, _9b9) {
        ...
        _9ba.total -= 1;
        $(_9b8).datagrid("getPager").pagination("refresh", {
            total: _9ba.total
        });
        ...
        $(_a21).datagrid($.extend({}, opts, {
            ...
            columns: (opts.columns && opts.columns.length) ? opts.columns : [
                [{
                    ...
                    width: "100%",
                    formatter: function (_a22, row, _a23) {
...
(function ($) {
    ...
    function _a43(_a44) {
        ...
        for (var _a4b in opts.panelEvents) {
            _a45.panel.bind(_a4b + ".combo", {
                target: _a44
            }, opts.panelEvents[_a4b]);
        }
    };
    ...
    $.fn.combotree = function (_b19, _b1a) {
        ...
        return this.each(function () {
            ...
            if (_b1c) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({}, $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _b19)
                });
            }
            _afd(this);
        });
    ...
    $.fn.combogrid = function (_b5b, _b5c) {
        ...
        return this.each(function () {
            ...
            if (_b5e) {
                ...
                _b5e = $.data(this, "combogrid", {
                    options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _b5b)
                });
            }
            _b23(this);
        });
...
(function ($) {
    ...
    $.fn.combotreegrid = function (_b82, _b83) {
        ...
        return this.each(function () {
            ...
            if (_b85) {
                ...
                _b85 = $.data(this, "combotreegrid", {
                    options: $.extend({}, $.fn.combotreegrid.defaults, $.fn.combotreegrid.parseOptions(this), _b82)
                });
            }
            _b65(this);
        });
    ...
    $.fn.combotreegrid.parseOptions = function (_b8a) {
        var t = $(_b8a);
        return $.extend({}, $.fn.combo.parseOptions(_b8a), $.fn.treegrid.parseOptions(_b8a), $.parser.parseOptions(_b8a, ["mode", {
            limitToGrid: "boolean"
        }]));
    };
    ...
    function _b8c(_b8d) {
        ...
        $(_b8d).addClass("tagbox-f").combobox($.extend({}, opts, {
            ...
            onResizing: function (_b92, _b93) {
                ...
                tb.css({
                    height: "",
                    paddingLeft: _b94.css("marginLeft"),
                    paddingRight: _b94.css("marginRight")
                });
                _b94.css("margin", 0);
                tb._size({
                    width: opts.width
    ...
    $.fn.tagbox = function (_bb6, _bb7) {
        ...
        return this.each(function () {
            ...
            if (_bb9) {
                ...
                $.data(this, "tagbox", {
                    options: $.extend({}, $.fn.tagbox.defaults, $.fn.tagbox.parseOptions(this), _bb6)
                });
            }
            _b8c(this);
            _ba2(this);
    ...
    $.fn.datebox = function (_be1, _be2) {
        ...
        return this.each(function () {
            ...
            if (_be4) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({}, $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _be1)
                });
            }
            _bc4(this);
        });
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_c04) {
                ...
                $.data(this, "datetimebox", {
                    options: $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _c01)
                });
            }
            _bef(this);
        });
    ...
    $.fn.datetimebox.parseOptions = function (_c09) {
        var t = $(_c09);
        return $.extend({}, $.fn.datebox.parseOptions(_c09), $.parser.parseOptions(_c09, ["timeSeparator", "spinnerWidth", {
            showSeconds: "boolean"
        }]));
    };
